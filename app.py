...
def run_query(sql):
    ...
    if response.status.state != StatementState.SUCCEEDED:
        raise Exception(str(response.status.error))
...
.example { padding: 7px 14px; background: #E8E1CE; border: 1.5px solid #C6B78A; border-radius: 20px; cursor: pointer; font-size: 12px; color: #004567; font-family: 'Roboto', sans-serif; font-weight: 500; }
...
.caveat { background: linear-gradient(135deg, #004567 0%, #5C6082 100%); border-radius: 10px; padding: 16px 18px; margin-top: 18px; color: #C6B78A; font-size: 12px; line-height: 1.6; }
...
<div class="container">
  ...
  <div class="scores">
    ...
    <div class="score-card violations">
      <div class="value" id="viol">-</div>
      <div class="label">Violations</div>
    </div>
    <div class="score-card">
      <div class="value" id="comp">-</div>
      <div class="label">Completeness</div>
    </div>
    <div class="score-card">
      <div class="value" id="rp">-</div>
      <div class="label">Rule Pass Rate</div>
    </div>
  </div>
  ...
  <div class="answer-box" id="answer-box">
    ...
    <div class="caveat" id="answer-caveat">
...
<div class="footer">
  <span>CHRYSELYS</span> &nbsp;|&nbsp; Data. Impacts. Lives. &nbsp;|&nbsp; Powered by Databricks
</div>
